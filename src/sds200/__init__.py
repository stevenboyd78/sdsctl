"""Public scanner API, loaded on first use.

Importing a focused submodule (notably the short-lived browser native helper)
must not initialize the unrelated audio, catalog, and favorites APIs.
"""

# The explicit re-exports are supplied to type checkers by _public, and at
# runtime by __getattr__. Keep __all__ available without loading those modules.
# ruff: noqa: F405
...
__all__ = [
    ...
    "DAEMON_SOCKET_MODE",
    "DAEMON_WATERFALL_CLIENT_DEFAULT_TIMEOUT",
    "DAEMON_WATERFALL_DEFAULT_ACCEPT_POLL_INTERVAL",
    "DAEMON_WATERFALL_DEFAULT_MAX_CLIENTS",
    "DAEMON_WATERFALL_DEFAULT_MAX_RECORD_BYTES",
    "DAEMON_WATERFALL_DEFAULT_SEND_TIMEOUT",
    "DAEMON_WATERFALL_DEFAULT_SHUTDOWN_TIMEOUT",
    ...
    "HOME_ASSISTANT_LIVE_AUDIO_BIT_RATE",
    "HOME_ASSISTANT_LIVE_AUDIO_CHANNELS",
    "HOME_ASSISTANT_LIVE_AUDIO_CODEC",
    "HOME_ASSISTANT_LIVE_AUDIO_DEFAULT_FIRST_BYTE_TIMEOUT",
    "HOME_ASSISTANT_LIVE_AUDIO_DEFAULT_IDLE_TIMEOUT",
    "HOME_ASSISTANT_LIVE_AUDIO_DEFAULT_MAXIMUM_DURATION",
    "HOME_ASSISTANT_LIVE_AUDIO_DEFAULT_MAX_LEASES",
    "HOME_ASSISTANT_LIVE_AUDIO_DEFAULT_QUEUE_BYTES",
    "HOME_ASSISTANT_LIVE_AUDIO_DEFAULT_SWEEP_INTERVAL",
    "HOME_ASSISTANT_LIVE_AUDIO_FORMAT",
    "HOME_ASSISTANT_LIVE_AUDIO_MIME_TYPE",
    "HOME_ASSISTANT_LIVE_AUDIO_SAMPLE_RATE",
    "HomeAssistantLiveAudioFormat",
    "LiveAudioEncoderPipeline",
    "LiveAudioEncoderPipelineSnapshot",
    "LiveAudioLease",
    "LiveAudioLeaseClosed",
    "LiveAudioLeaseCloseReason",
    "LiveAudioLeaseSnapshot",
    "LiveAudioPipeline",
    "LiveAudioSession",
    "LiveAudioSessionSnapshot",
...
def __getattr__(name: str) -> object:
    ...
    # Python's import lock serializes initialization. Publish only the existing
    # documented exports, and keep their original objects (no proxy wrappers).
    public = _import_module("._public", __name__)
    exports = {export: getattr(public, export) for export in __all__}
