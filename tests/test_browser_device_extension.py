...
def test_browser_recovery_coordinator_contract() -> None:
    ...
    result = subprocess.run(
        [node, "--test", "scripts/experimental/test_browser_device_recovery.mjs",
         ...
         "scripts/experimental/test_browser_device_continuation_accepted.mjs",
         "scripts/experimental/test_browser_device_continuation_pause.mjs",
         "scripts/experimental/test_browser_device_continuation_stop_owner.mjs",
         "scripts/experimental/test_browser_device_continuation_logout_content.mjs",
         "scripts/experimental/test_browser_device_continuation_logout_channel.mjs",
         "scripts/experimental/test_browser_device_continuation_lifecycle.mjs",
         "scripts/experimental/test_browser_device_continuation_inspect.mjs",
